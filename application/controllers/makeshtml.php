	...
	class Makeshtml extends My_Controller
	{
		...
		public function makealllist()
		{
			...
			if ($gameinfo['makelist'])
			{
				...
				{
					$dirpath = '/data/www/html/site/' . $domain . '/web/list';
			...
			if ($gameinfo['wapmakelist'])
			{
				...
				{
					$wapdirpath = '/data/www/html/site/' . $domain . '/wap/list/';
		...
		public function makearticle()
		{
			...
			if ($gameinfo['makelist'])
			{
				...
				{
					$dirpath = '/data/www/html/site/' . $domain . '/web/news/';
			...
			if ($gameinfo['wapmakelist'])
			{
				...
				{
					$wapdirpath = '/data/www/html/site/' . $domain . '/wap/news/';
		...
		public function makelist()
		{
			...
			$listpath = '/data/www/html/site/' . $gameinfo['domain'] . '/list';
		...
		public function makeaction()
		{
			...
			$dirpath = '/data/www/html/site/' . $domain . '/list/';
